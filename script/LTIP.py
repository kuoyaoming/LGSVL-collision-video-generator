...
state1.transform.position = spawns[0].position + 252.5 * forward + -127*right
...
state.transform.position = spawns[0].position + 325*forward - 201.5 * right
...
# # np.savetxt('LTIP.csv', a.T, delimiter=',', fmt='%.2f')
