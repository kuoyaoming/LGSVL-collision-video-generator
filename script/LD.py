...
state1.transform.position = spawns[0].position + 252.5 * forward + -141*right
...
state.transform.position = spawns[0].position + 195*forward - 193 * right
...
# np.savetxt('LD.csv', a.T, delimiter=',', fmt='%.2f')
